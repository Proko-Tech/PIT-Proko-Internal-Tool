...
var tooltipsOpts = {
    ...
    custom: function(tooltipModel) {
        ...
        tooltipEl.style.left =
            ...
            'px';
        tooltipEl.style.top =
            $(window).scrollTop() + position.top + tooltipModel.caretY + 'px';
    ...
    if (chart.data.datasets.length) {
        for (var i = 0; i < chart.data.datasets[0].data.length; i++) {
            ...
            var $li = $(
                ...
                color +
                '" class="dot"></span><span class="label">' +
                labels[i] +
...
var cardLegendCallback = function(chart) {
    ...
    for (var i = 0; i < chart.data.datasets.length; i++) {
        ...
        var $title = $(
            '<div class="card-metric-title">' + dataset.label + '</div>',
        );
...
(function($) {
    $(document).ready(function() {
        ...
        Chart.defaults.global.tooltips = Object.assign(
        ...
        tabLegendLine
            ...
            .before($(tabLegendLineChart.generateLegend()));
