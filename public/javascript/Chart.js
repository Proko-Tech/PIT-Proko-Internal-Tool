                        ...
                        Chart.Scale = Element.extend({
                            ...
                            calculateTickRotation: function() {
                                ...
                                if (
                                    ...
                                    while (
                                        ...
                                        var angleRadians =
                                            helpers.toRadians(labelRotation);
                            ...
                            fit: function() {
                                ...
                                if (scaleLabelOpts.display && display) {
                                    var scaleLabelLineHeight =
                                        parseLineHeight(scaleLabelOpts);
                                    var scaleLabelPadding =
                                        helpers.options.toPadding(
                            ...
                            draw: function(chartArea) {
                                ...
                                var majorTickFont =
                                    parseFontOptions(optionMajorTicks);
                        ...
                        Chart.Tooltip = Element.extend({
                            ...
                            handleEvent: function(e) {
                                ...
                                if (e.type === 'mouseout') {
                                    ...
                                    me._active =
                                        me._chart.getElementsAtEventForMode(
                                            e,
                                            options.mode,
                                            options,
                                        );
                                    ...
                                    helpers.each(
                                        ...
                                        function(valuesForType) {
                                            if (valuesForType.length > 0) {
                                                var minVal =
                                                    helpers.min(valuesForType);
                                                var maxVal =
                                                    helpers.max(valuesForType);
                                                me.min =
                                                    me.min === null ?
                                                        minVal :
                                                        Math.min(
                    ...
                    module.exports = function(Chart) {
                        ...
                        var LinearRadialScale = Chart.LinearScaleBase.extend({
                            ...
                            setReductions: function(
                                ...
                                radiusReductionLeft =
                                    numberOrZero(radiusReductionLeft);
                                radiusReductionRight =
                                    numberOrZero(radiusReductionRight);
                                radiusReductionTop =
                                    numberOrZero(radiusReductionTop);
                                    ...
                                    helpers.each(
                                        ...
                                        function(label, index) {
                                            ...
                                            if (index > 0 || tickOpts.reverse) {
                                                var yCenterOffset =
                                                    me.getDistanceFromCenterForValue(
                    ...
                    module.exports = function(Chart) {
                        ...
                        var TimeScale = Chart.Scale.extend({
                            ...
                            getLabelWidth: function(label) {
                                ...
                                var tickLabelWidth =
                                    me.ctx.measureText(label).width;
