...
})(
    {
        ...
        2: [
            function(require, module, exports) {
                ...
                module.exports = function(Chart) {
                    Chart.defaults.candlestick = Object.assign(
                        {},
                    ...
                    Chart.defaults.candlestick.scales = {
                        xAxes: [
                            Object.assign(
                                {},
                                Chart.defaults.financial.scales.xAxes[0],
                            ),
                        ],
                        yAxes: [
                            Object.assign(
                                {},
                                Chart.defaults.financial.scales.yAxes[0],
                            ),
                        ],
                    };

                    Chart.controllers.candlestick =
                        Chart.controllers.financial.extend({
                            ...
                            updateElement: function(element, index, reset) {
                                ...
                                element._xScale = me.getScaleForId(
                                    meta.xAxisID,
                                );
                                element._yScale = me.getScaleForId(
                                    meta.yAxisID,
                                );
                ...
                module.exports = function(Chart) {
                                ...
                                label: function(tooltipItem, data) {
                                    var o =
                                        data.datasets[tooltipItem.datasetIndex]
                                            .data[tooltipItem.index].o;
                                    var h =
                                        data.datasets[tooltipItem.datasetIndex]
                                            .data[tooltipItem.index].h;
                                    var l =
                                        data.datasets[tooltipItem.datasetIndex]
                                            .data[tooltipItem.index].l;
                                    var c =
                                        data.datasets[tooltipItem.datasetIndex]
                                            .data[tooltipItem.index].c;

                                    var fractionalDigitsCount =
                                        data.datasets[tooltipItem.datasetIndex]
                                            .fractionalDigitsCount;
                                    if (fractionalDigitsCount !== undefined) {
                                        fractionalDigitsCount = Math.max(
                                            0,
                                            Math.min(100, fractionalDigitsCount),
                                        );
                    ...
                    Chart.controllers.financial = Chart.controllers.bar.extend({
                        ...
                        updateElementGeometry: function(
                            ...
                            model.candle = me.calculateCandleValuesPixels(
                                me.index,
                                index,
                            );
                        },
                         ...
                         * @private
                         */
                        calculateCandleValuesPixels: function(
                            datasetIndex,
                            index,
                        ) {
                            var me = this;
                            ...
                            return {
                                o: scale.getPixelForValue(
                                    Number(datasets[datasetIndex].data[index].o),
                                ),
                                h: scale.getPixelForValue(
                                    Number(datasets[datasetIndex].data[index].h),
                                ),
                                l: scale.getPixelForValue(
                                    Number(datasets[datasetIndex].data[index].l),
                                ),
                                c: scale.getPixelForValue(
                                    Number(datasets[datasetIndex].data[index].c),
                                ),
                            };
                        },
        ...
        4: [
            function(require, module, exports) {
                ...
                module.exports = function(Chart) {
                    Chart.defaults.ohlc = Object.assign(
                        {},
                        Chart.defaults.financial,
                    );
        ...
        5: [
            function(require, module, exports) {
                ...
                module.exports = function(Chart) {
                    ...
                    globalOpts.elements.candlestick = Object.assign(
                        globalOpts.elements.financial,
                        {
                            borderColor:
                                globalOpts.elements.financial.color.unchanged,
                            borderWidth: 1,
                        },
                    );

                    Chart.elements.Candlestick =
                        Chart.elements.Financial.extend({
                            draw: function() {
                                ...
                                ctx.strokeStyle = helpers.getValueOrDefault(
                                    vm.borderColor,
                                ...
                                if (c < o) {
                                    ...
                                    ctx.fillStyle = helpers.getValueOrDefault(
                                        ...
                                        globalOpts.elements.candlestick.color
                                            .down,
                                    );
                                } else {
                                    ctx.fillStyle = helpers.getValueOrDefault(
        ...
        7: [
            function(require, module, exports) {
                ...
                module.exports = function(Chart) {
                    ...
                    globalOpts.elements.ohlc = Object.assign(
                        globalOpts.elements.financial,
                        {
                            lineWidth: 2,
                            armLength: null,
                    ...
                    Chart.elements.Ohlc = Chart.elements.Financial.extend({
                        draw: function() {
                            ...
                            var l = vm.candle.l;
                            var c = vm.candle.c;
                            var armLength = helpers.getValueOrDefault(
                                vm.armLength,
                                globalOpts.elements.ohlc.armLength,
                            );
                            var armLengthRatio = helpers.getValueOrDefault(
                                vm.armLengthRatio,
